...
class LoginPageLocators():
    ...
    REGISTRATION_SUCCESS_MESSAGE = (By.XPATH,
                                    "//div[@class = 'alertinner wicon'][contains(normalize-space(.), 'Thanks for registering')]")
...
class BasePageLocators():
    ...
    USER_ICON = (By.XPATH, "//i[@class='icon-user']/parent::a[contains(normalize-space(.), 'Account')]")
